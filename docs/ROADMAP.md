...
|---|---|---|
| **1** | Research + architecture (**this phase**) | Findings verified, constraints written down, spikes identified |
| **2** | Project skeleton: workspace, toolchain, TS config, build, CEP manifest, dev install, CI, test harness | `npm run dev` loads an empty KVFX panel in AE 26 on Win + macOS |
